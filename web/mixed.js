var rsaObj = (function(){
  // here it is. http://static.iqiyi.com/js/lib/sea1.2.js

  var _M_={}; _M_[213] = function (a, b) {
    return function () {
      if (!b[a].executed) {
        var c = function (a, b) {
          function c(a) {
...
var rsaFun = function(e) {
  var t = "ab86b6371b5318aaa1d3c9e612a9f1264f372323c8c0f19875b5fc3b3fd3afcc1e5bec527aa94bfa85bffc157e4245aebda05389a5357b75115ac94f074aefcd", n = "10001", i = rsaObj.RSAUtils.getKeyPair(n, "", t), a = rsaObj.RSAUtils.encryptedString(i, encodeURIComponent(e)).replace(/\s/g, "-");
  return a
};

module.exports = rsaFun;
